...
var homepage = class homepage {
  ...
  init() {
    var Overlay, self, visible;
    this.hc.visible = false;
    self = this;
    this.s.sticky_get_started.visible = false;
    Overlay = new Layer({
      image: 'app.framer/imported/app@2x/images/Layer-sticky_get_started-qtg5qzg2.png',
      width: 340,
      height: 36,
      y: this.flow.y,
      opacity: 0
    ...
    // body...
    this.assignTransition(this.s.get_started, self.s.Child_details, Overlay);
    this.assignTransition(this.s.sticky_get_started, self.s.Child_details, Overlay);
    this.assignTransition(this.s.get_started_code, self.s.Child_details_2, Overlay);
    this.assignTransition(this.s.sticky_get_started_code, self.s.Child_details_2, Overlay);
    return this.assignTransition(Overlay, self.s.Child_details_2, Overlay);
  }
...
/***/ })
/******/ ]);
//# sourceMappingURL=app.ec88b043bfb886a75981.js.map