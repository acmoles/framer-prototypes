...
var child = class child {
  ...
  init() {
    ...
    return this.s.box_details.on(Events.Click, function(event, layer) {
      self.caret.stateCycle('active', 'inactive');
      self.dropdown_inline_rectangle.stateCycle('active', 'inactive');
      self.whitemask_child.stateCycle('active', 'inactive');
      self.dropdown_dropped_rectangle.stateCycle('active', 'inactive');
      return self.dropped_boxes.stateCycle('active', 'inactive');
    });
  }
...
/***/ })
/******/ ]);
//# sourceMappingURL=app.314f618946ebc49d55a7.js.map