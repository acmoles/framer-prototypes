...
var child = class child {
  ...
  init() {
    ...
    return this.s.box_details.on(Events.Click, function(event, layer) {
      this.s.caret.animate('dropped');
      this.s.dropdown_inline_rectangle.animate('inactive');
      this.s.whitemask_child.animate('active');
      this.s.dropdown_dropped_rectangle.animate('active');
      return this.s.dropped_boxes.animate('active');
    });
  }
...
/***/ })
/******/ ]);
//# sourceMappingURL=app.9301ed539ad0fa5800a2.js.map