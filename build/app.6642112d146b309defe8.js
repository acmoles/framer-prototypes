...
var account, animationOptions, c, child, d, delivery, device, deviceHeight, deviceWidth, fadeTransition, flow, p, payment, s, sum, summary;
...
flow.scroll.a = new account(s, flow, fadeTransition);
...
var account = class account {
  ...
  init() {
    ...
    return this.s.continue_account.on(Events.Click, function(event, layer) {
      return self.flow.transition(self.s.Child_details, self.fadeTransition);
    });
  }
...
var child = class child {
  ...
  init() {
    var i, index, layer, len, ref, self;
    ref = this.a.children;
    ...
    this.s.continue_child.on(Events.Click, function(event, layer) {
      return self.flow.transition(self.s.Delivery_address, self.fadeTransition);
    });
...
/***/ })
/******/ ]);
//# sourceMappingURL=app.6642112d146b309defe8.js.map