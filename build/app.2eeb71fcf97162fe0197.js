...
var homepage = class homepage {
  ...
  init() {
    ...
    return this.assignTransition(this.s.sticky_code_get_started, self.s.Child_details_2);
  }
...
var product = class product {
  ...
  dropdownEvent(event, layer) {
    ...
    this.s.whitemask_products.visible = this.s.whitemask_child.visible ? false : true;
...
var payment = class payment {
  ...
  init() {
    ...
    this.assignTransition(this.s.continue_payment_2, self.s.Delivery_address_2);
...
/***/ })
/******/ ]);
//# sourceMappingURL=app.2eeb71fcf97162fe0197.js.map