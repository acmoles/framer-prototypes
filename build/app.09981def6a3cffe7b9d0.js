...
flow.backgroundColor = "#212121";

flow.showNext(a.screenElement);
...
var account = class account {
  ...
  init() {
    ...
    return this.a.parent = this.screenElement.content;
  }
...
var summary = class summary {
  constructor(s) {
    this.s = s;
    this.s = this.s.Summary;
    this.s1 = this.s.Summary_1;
    this.s2 = this.s.Summary_2;
    this.screenElement = new ScrollComponent({
      width: 360,
      height: 640,
      backgroundColor: "white"
  ...
  init() {
    ...
    this.s.parent = this.screenElement.content;
    this.s1.parent = this.screenElement.content;
    return this.s2.parent = this.screenElement.content;
  }
...
/***/ })
/******/ ]);
//# sourceMappingURL=app.09981def6a3cffe7b9d0.js.map