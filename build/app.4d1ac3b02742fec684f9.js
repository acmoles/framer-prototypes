...
var child = class child {
  ...
  init() {
    ...
    return this.s.box_details.on(Events.Click, function(event, layer) {
      ...
      self.s.whitemask_child.stateCycle('active', 'inactive');
      self.s.dropdown_dropped_rectangle.stateCycle('active', 'inactive');
      return self.s.dropped_boxes.stateCycle('active', 'inactive');
    });
  }
...
/***/ })
/******/ ]);
//# sourceMappingURL=app.4d1ac3b02742fec684f9.js.map