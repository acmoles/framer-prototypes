...
var account = class account {
  ...
  dropdownEvent(event, layer) {
    ...
    this.s.whitemask_account.visible = this.s.whitemask_products.visible ? false : true;
    this.s.whitemask_account.stateCycle('inactive', 'active');
    this.s.close_summary_unfolded.visible = this.s.dropdown_dropped_rectangle.visible ? false : true;
    return this.s.close_summary_unfolded.stateCycle('inactive', 'active');
  }
...
/***/ })
/******/ ]);
//# sourceMappingURL=app.b429db07c8d6253be6e6.js.map