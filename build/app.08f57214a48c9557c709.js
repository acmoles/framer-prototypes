...
var account = class account {
  ...
  init() {
    ...
    this.s.have_an_account.on(Events.Click, function(event, layer) {
      self.mask.opacity = 0.1;
      self.mask.visible = true;
      self.s.have_an_account_modal.opacity = 0.5;
      return self.s.have_an_account_modal.visible = true;
    });
    return this.s.have_an_account_modal.login.on(Events.Click, function(event, layer) {
      self.mask.opacity = 1;
      self.mask.visible = false;
      self.s.have_an_account_modal.opacity = 1;
      return self.s.have_an_account_modal.visible = false;
    });
  }
...
var child = class child {
  ...
  init() {
    ...
    return this.assignTransition(this.s.continue_child_2, self.s.Delivery_address);
  }
...
var delivery = class delivery {
  ...
  init() {
    ...
    return this.assignTransition(this.s.continue_address_2, self.s.Payment_details);
  }
...
var payment = class payment {
  ...
  init() {
    ...
    return this.assignTransition(this.s.continue_payment_2, self.s.Summary_2);
  }
...
/***/ })
/******/ ]);
//# sourceMappingURL=app.08f57214a48c9557c709.js.map