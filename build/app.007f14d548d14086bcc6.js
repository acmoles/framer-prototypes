...
var account = class account {
  ...
  init() {
    ...
    this.s.have_an_account.on(Events.Click, function(event, layer) {
      ...
      sl.s.summary_account.states.faded = {
        opacity: 0.2
      };
      return sl.s.summary_account.animate('faded');
    });
    this.s.summary_title.on(Events.Click, function(event, layer) {
      return sl.s.caret_account.animate({
        rotation: Math.Pi
      });
    });
...
/***/ })
/******/ ]);
//# sourceMappingURL=app.007f14d548d14086bcc6.js.map