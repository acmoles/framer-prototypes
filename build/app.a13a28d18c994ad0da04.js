...
var homepage = class homepage {
  ...
  init() {
    ...
    this.s.sticky_get_started.y = this.flow.y;
    ...
    this.flow.scroll.onMove(function() {
      if (self.flow.scroll.scrollY >= 700 && !visible) {
        visible = true;
        return this.s.sticky_get_started.stateCycle('in', 'out');
      } else if (self.flow.scroll.scrollY < 700 && visible) {
        visible = false;
        return this.s.sticky_get_started.stateCycle('out', 'in');
      } else {
    ...
    this.assignTransition(this.s.sticky_get_started_code, self.s.Child_details_2, this.s.sticky_get_started);
    return this.assignTransition(this.s.sticky_get_started, self.s.Child_details_2, this.s.sticky_get_started);
  }
  ...
  assignTransition(button, transitionTo, Overlay) {
    ...
    return button.on(Events.Click, function(event, layer) {
      this.s.sticky_get_started.stateCycle('out', 'in');
...
/***/ })
/******/ ]);
//# sourceMappingURL=app.a13a28d18c994ad0da04.js.map