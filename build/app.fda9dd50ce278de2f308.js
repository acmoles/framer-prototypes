...
var child = class child {
  ...
  init() {
    ...
    return this.s.box_details.on(Events.Click, function(event, layer) {
      ...
      this.s.whitemask_child.stateCycle('active', 'inactive');
      this.s.dropdown_dropped_rectangle.stateCycle('active', 'inactive');
      return this.s.dropped_boxes.stateCycle('active', 'inactive');
    });
  }
...
/***/ })
/******/ ]);
//# sourceMappingURL=app.fda9dd50ce278de2f308.js.map