...
var account = class account {
  ...
  init() {
    ...
    return this.s.login.on(Events.Click, function(event, layer) {
      ...
      self.s.have_an_account_modal.visible = false;
      self.s.unfilled_details.visible = false;
      return self.s.filled_in_details.visible = true;
    });
  }
...
/***/ })
/******/ ]);
//# sourceMappingURL=app.c26a06141b082411a1a4.js.map