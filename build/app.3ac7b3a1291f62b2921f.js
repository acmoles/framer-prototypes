...
var a, account, animationOptions, c, child, d, delivery, device, deviceHeight, deviceWidth, flow, s;
...
var account = class account {
  constructor(s) {
    ...
    this.screenElement.center();
  }

  init() {
    print("account initiated");
    return this.a.parent = this.screenElement;
  }
...
/***/ })
/******/ ]);
//# sourceMappingURL=app.3ac7b3a1291f62b2921f.js.map