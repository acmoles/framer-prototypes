...
var child = class child {
  ...
  init() {
    ...
    clickoff = [this.s.box_details, this.s.dropped_boxes, this.s.dropdown_dropped_rectangle];
    results = [];
  ...
  dropdownEvent(event, layer) {
    ...
    this.s.dropdown_inline_rectangle.stateCycle('active', 'inactive');
    this.s.whitemask_child.visible = true;
    this.s.whitemask_child.stateCycle('inactive', 'active');
    this.s.dropdown_dropped_rectangle.visible = true;
    this.s.dropdown_dropped_rectangle.stateCycle('inactive', 'active');
    this.s.dropped_boxes.visible = true;
  ...
  assignActiveState(object) {
    ...
    return object.states.stateSwitch('inactive');
  }
  ...
  assignInactiveState(object) {
    ...
    return object.states.stateSwitch('active');
  }
...
/***/ })
/******/ ]);
//# sourceMappingURL=app.4064c8e091c1606d38d9.js.map